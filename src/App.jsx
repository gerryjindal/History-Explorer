        ...
        <div className="dropdown-container">
          ...
          {showDropdown && (
            <ul className="dropdown-menu">
              ...
              <li><button className="dropdown-link" onClick={() => handleClick('wars')}>Wars History</button></li>
              ...
              <li><button className="dropdown-link" onClick={() => handleClick('WIKI')}>Independence History</button></li>
            </ul>
          )}
        </div>   
      </nav>
        ...
        {currentPage === null && (
          <div className="history-boxes">
            ...
            <div className="history-box" onClick={() => handleClick('wars')}>
              <h2>Wars History</h2>
              <p>The history of warfare is a testament to humanities capacity for both innovation and destruction, with conflicts shaping the course of nations, cultures, and civilizations throughout the ages. From ancient battles fought with spears and swords to modern conflicts waged with advanced technology and global alliances.</p>
            </div>
            ...
            <div className="history-box" onClick={() => handleClick('WIKI')}>
...
<div className='newcon'>
        ...
        {currentPage === 'WIKI' && <IndependenceHistory />}
